...
- Updated dependencies [39a9ea5]
  ...
  - @neurodesk/topofit@0.11.20260924
...
- 3e6b9a7: Add a Support action to the shared application bar, so every webapp offers one
  ...
  - @neurodesk/topofit@0.11.20260923

## 0.11.20260920

### Minor Changes

- 4882b95: Preserve the selected viewer layout when viewing or toggling surfaces. Selecting a surface in ACS now shows its boundaries on the slices instead of switching to 3D.

  Record surface analysis measurements and the processing manifest in the technical log instead of offering them as downloadable results.

  Honor explicit anatomy visibility changes in FreeBrowse and retain that choice when selecting another surface.

  Add optional outward mid-surface normal arrows with physical spacing and length controls, following visible surfaces and using the same area-weighted normals as the CSV export.

### Patch Changes

- Updated dependencies [4882b95]
  - @neurodesk/topofit@0.11.20260920
...
- Updated dependencies
  ...
  - @neurodesk/topofit@0.9.20260920
